...
class RedisService:
    ...
    def __init__(self):
        self.url = os.getenv("REFRAME_UPSTASH_REDIS_REST_URL", os.getenv("UPSTASH_REDIS_REST_URL"))
        self.token = os.getenv("REFRAME_UPSTASH_REDIS_REST_TOKEN", os.getenv("UPSTASH_REDIS_REST_TOKEN"))
