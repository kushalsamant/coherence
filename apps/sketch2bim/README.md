...
### 8. Troubleshooting
- **Missing Redis:** Use Upstash or start a local Redis (`docker run -p 6379:6379 redis`)
...
- **Sandboxed Job Execution** (`backend/app/worker/docker_runner.py`)
...
- **Docker Containerization**: Multi-stage builds, non-root user, health checks
- **Kubernetes Manifests**: Backend deployment, Celery worker, HPA
- **CI/CD Pipeline**: Automated testing, Docker image building, deployment automation
