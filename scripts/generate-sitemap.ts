...
const staticRoutes: SitemapEntry[] = [
  ...
  { url: '/ask', lastMod: new Date(), changeFreq: 'daily', priority: 0.9 },
  { url: '/reframe', lastMod: new Date(), changeFreq: 'daily', priority: 0.9 },
  { url: '/sketch2bim', lastMod: new Date(), changeFreq: 'daily', priority: 0.9 },
