...
$healthEndpoints = @{
    "ASK Backend" = "https://ask-api.onrender.com/health"
    "Reframe Backend" = "https://reframe-api.onrender.com/health"
...
if ($SkipAuth) {
    ...
    Write-Host "    - ASK: https://ask.kvshvl.in" -ForegroundColor Gray
    Write-Host "    - Reframe: https://reframe.kvshvl.in" -ForegroundColor Gray
