    ...
    <Card className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <p className={`text-lg font-semibold ${data.contribution_margin_per_user_usd >= 0 ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div>
          ...
          <p className={`text-lg font-semibold ${data.is_feasible ? 'text-green-600' : 'text-red-600'}`}>
